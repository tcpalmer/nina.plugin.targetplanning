...
namespace TargetPlanning.NINAPlugin.Astrometry {
    ...
    public abstract class Solver {
        ...
        public Solver(IAltitudeRefiner refiner, long maxFinalTimeStep) {
            Validate.Assert.notNull(refiner, "refiner cannot be null");
            Validate.Assert.isTrue(maxFinalTimeStep >= 1, "max final time step must be >= 1");
        ...
        public long GetStepInterval(Altitudes step) {
            Validate.Assert.notNull(step, "step cannot be null");
            Validate.Assert.isTrue(step.AltitudeList.Count == 2, "altitudes must have exactly two points");
    ...
    public class RisingFunction : StepFunction {
        ...
        public Altitudes determineStep(Altitudes altitudes) {
            ...
            Validate.Assert.isTrue(altitudes.AltitudeList.Count > 1, "altitudes must have at least two points");
    ...
    class TransitFunction : StepFunction {
        ...
        public Altitudes determineStep(Altitudes altitudes) {
            Validate.Assert.notNull(altitudes, "altitudes cannot be null");
            Validate.Assert.isTrue(altitudes.AltitudeList.Count > 2, "altitudes must have at least three points");
