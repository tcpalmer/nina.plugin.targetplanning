...
namespace NINA.Plugin.TargetPlanning.Test.Astrometry {
    ...
    public class NighttimeCircumstancesTest {
        ...
        public void testLocal() {
            ...
            Tuple<DateTime, DateTime> span = sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_CIVIL);
            ...
            span = sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_NAUTICAL);
            ...
            span = sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_ASTRO);
            ...
            span = sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_NONE);
        ...
        public void testHighLatitude() {
            ...
            sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_NONE).Should().BeNull();
            ...
            sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_NONE).Should().BeNull();
            sut.GetTwilightSpan(NighttimeCircumstances.TWILIGHT_INCLUDE_ASTRO).Should().BeNull();
            dt = dt.AddDays(1);
