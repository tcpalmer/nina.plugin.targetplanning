...
namespace TargetPlanning.NINAPlugin.Astrometry {
    ...
    public class NighttimeCircumstances {
        ...
        private const int TWILIGHT_ALL = -1;
        ...
        public int TwilightInclude { get; private set; }
        ...
        public NighttimeCircumstances(ObserverInfo observerInfo, DateTime onDate) : this(observerInfo, onDate, TWILIGHT_ALL) { }

        public NighttimeCircumstances(ObserverInfo observerInfo, DateTime onDate, int twilightInclude) {
            ...
            NighttimeCircumstances cached = NighttimeCircumstancesCache.GetNighttimeCircumstances(cacheKey);
            if (cached == null) {
                Calculate();
                NighttimeCircumstancesCache.PutNighttimeCircumstances(this, cacheKey);
            }
            else {
                ...
                this.TwilightInclude = cached.TwilightInclude;
            }
        }
        ...
        private void Calculate() {
            ...
            if (TwilightInclude == TWILIGHT_ALL) {
    ...
    class NighttimeCircumstancesCache {
        ...
        public static NighttimeCircumstances GetNighttimeCircumstances(string cacheKey) {
            return (NighttimeCircumstances)_cache.Get(cacheKey);
        }

        public static void PutNighttimeCircumstances(NighttimeCircumstances nighttimeCircumstances, string cacheKey) {
