...
namespace NINA.Plugin.TargetPlanning.Test.Astrometry {
    ...
    public class ImagingDayPlanTest {
        ...
        public void Test() {
            ...
            ImagingDayPlan plan = new ImagingDayPlan(start, end, transit, ImagingLimit.Twilight, ImagingLimit.MinimumAltitude, .7, 10);
        ...
        public void TestNotVisible() {
            ...
            ImagingDayPlan plan = new ImagingDayPlan(start, end, transit, ImagingLimit.NotVisible, ImagingLimit.NotVisible, 0, 0);
        ...
        public void TestGetImagingMinutes() {
            ...
            ImagingDayPlan plan = new ImagingDayPlan(start, end, transit, ImagingLimit.Twilight, ImagingLimit.Twilight, 0, 0);
        ...
        public void TestAboveMaximumMoonIllumination() {
            ...
            ImagingDayPlan plan = new ImagingDayPlan(start, end, transit, ImagingLimit.MoonIllumination, ImagingLimit.MoonIllumination, 0, 0);
            plan.AboveMaximumMoonIllumination().Should().BeTrue();

            plan = new ImagingDayPlan(start, end, transit, ImagingLimit.Twilight, ImagingLimit.Twilight, 0, 0);
        ...
        public void TestBelowMinimumMoonSeparation() {
            ...
            ImagingDayPlan plan = new ImagingDayPlan(start, end, transit, ImagingLimit.MoonSeparation, ImagingLimit.MoonSeparation, 0, 0);
        ...
        public void TestBad() {
            ...
            var ex = Assert.Throws<ArgumentException>(() => new ImagingDayPlan(start, end, transit, null, null, 0, 0));
            ex.Message.Should().Be("startLimitingFactor cannot be null");

            ex = Assert.Throws<ArgumentException>(() => new ImagingDayPlan(start, end, transit, ImagingLimit.Twilight, null, 0, 0));
